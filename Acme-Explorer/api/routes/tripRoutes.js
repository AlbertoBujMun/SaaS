...
module.exports = function(app) {
     ...
     *           $ref: '#/definitions/Trip'
     */
    app.route("/v1/trips/myTrips").get(trip.list_an_actor_trips);
     ...
     *           $ref: '#/definitions/Trip'
     */
    app.route("/v1/trips/simpleSearch/:keyword").get(trip.list_trips_by_keyword);
     ...
     *           $ref: '#/definitions/Trip'
     */
    app.route("/v1/trips/advancedSearch/:finderId").get(trip.search_trips);
     ...
     *           $ref: '#/definitions/Trip'
     */
    app.route("/v1/trips/cancel/:tripId").put(trip.cancel_trip);
};