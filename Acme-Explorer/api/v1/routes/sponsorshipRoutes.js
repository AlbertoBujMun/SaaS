...
module.exports = function(app) {
   ...
   *
   */
  app.route("/v1/sponsorships").post(sponsorships.create_a_sponsorship);
  /**
   * @swagger
   ...
   *           $ref: '#/definitions/SponsorShip'
   */
  app.route("/v1/sponsorships/own").get(sponsorships.list_sponsorships);
  /**
   * @swagger
   ...
   *           $ref: '#/definitions/SponsorShip'
   */
  app.route("/v1/sponsorships/random/:ticker").get(sponsorships.find_random);
};
