...
module.exports = function(app) {
    ...
    app
        ...
        .post( /*authController.verifyUser(["EXPLORER"]),*/ tripApplication.create_a_tripApplication);
    ...
    app
        ...
        .put( /*authController.verifyUser(["EXPLORER"]),*/ tripApplication.cancel_trip_application);
    ...
    app
        ...
        .put( /*authController.verifyUser(["EXPLORER"]),*/ tripApplication.pay_a_tripApplication);
